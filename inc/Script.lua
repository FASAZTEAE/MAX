...
sendMsg(msg.chat_id_,msg.id_,'📛*│* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس كاولي يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n💥')
end  
else
...
⚜│[قناة شروحات السورس](t.me/iraqqpqp)
🤖│[بوت تواصل](t.me/COWLEYX_BOT)
👨🏻‍✈️╽[مطور السـورس](t.me/sarazzvevoqpqp)
●ـ▬ــ▬ஜ۩۞۩ஜ▬ـ▬ـ●
...
elseif Text== "حسن" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس 😍](t.me/sarazzvevoqpqp")
elseif Text== "حسن العراقي" then return sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس كاولي 😍](t.me/sarazzqpqpvevo")
