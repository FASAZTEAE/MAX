...
return '👨🏾‍🔧¦ اصدار سورس الكاولي : *v'..version..'* \n📡'
end
...
sendMsg(arg.chat_id_,arg.id_,'📛*¦* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس الكاولي يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
🔰┇COWLEY TEAM
 ء━━━━━━━━━━━━━━
📮┇[قناه السورس](t.me/TH3BS) 

👮‍♂️┇[مطور السورس](sarazzqpqpvevo

🔖┇[كليشه التنصيب](https://t.me/IRAQeaq/9)

📌┇[لــ تواصل](t.me/COWLEYX_BOT)
]]
end

if MsgText[1] == "متجر ملفات" or MsgText[1]:lower() == "/store"  then
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
